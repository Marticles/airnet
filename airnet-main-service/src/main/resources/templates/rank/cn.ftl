        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">全国空气质量实时排行</li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <span>全国空气质量最佳城市实时排名 (Updated on ${updatedTime!})</span>
                                ...
                                <table class="table color-table primary-table hover-table">
                                    ...
                                    <#list cityRanks as cityRank>
                                        <tr>
                                            ...
                                            <td>${cityRank.pm25}</td>
                                            <#if cityRank.level=="优">
                                            <td><span class="label label-success">${cityRank.level}</span></td>
                                            </#if>
                                            <#if cityRank.level=="良">
                                            <td><span class="label label-info">${cityRank.level}</span></td>
                                            </#if>
                                        </tr
                                    <#assign i += 1>
                                    </#list>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <span>全国空气质量最差城市实时排名 (Updated on ${updatedTime!})</span>
                            <div class="card-actions">
                                <a class="" data-action="collapse"><i class="ti-minus"></i></a>
                                <a class="btn-minimize" data-action="expand"><i class="mdi mdi-arrow-expand"></i></a>
                                <a class="btn-close" data-action="close"><i class="ti-close"></i></a>
                        ...
                        <div class="card-body ">
                            <div class="table-responsive">
                                <table class="table color-table danger-table hover-table">
                                    ...
                                    <#assign j = 1>
                                    <#list reverseCityRanks as reverseCityRank>
                                        <tr>
                                            <td>${j}</td>
                                            <td>${reverseCityRank.city}</td>
                                            <td>${reverseCityRank.aqi}</td>
                                            <td>${reverseCityRank.pm25}</td>
                                            <#if reverseCityRank.level=="重度污染">
                                            <td><span class="label label-danger">${reverseCityRank.level}</span></td>
                                            </#if>
                                            <#if reverseCityRank.level=="严重污染">
                                            <td><span class="label label-danger">${reverseCityRank.level}</span></td>
                                            </#if>
                                            <#if reverseCityRank.level=="中度污染">
                                            <td><span class="label label-warning">${reverseCityRank.level}</span></td>
                                            </#if>
                                            <#if reverseCityRank.level=="轻度污染">
                                            <td><span class="label label-light-warning">${reverseCityRank.level}</span></td>
                                            </#if>
                                        </tr
                                    <#assign j += 1>
                                    </#list>
...
<style type="text/css">
border-radius:.25em}.aqi-level-1{background-color:#468847}
</style>