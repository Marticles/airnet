        ...
        <div class="login-register" style="background-image:url(/static/images/background/login-register.svg);">
            <div class="login-box card">
                <div class="card-body">
                        ...
                        <h3 class="box-title m-b-20" style="text-align:center;">AirNet® 管理员登录</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" id="name" required="" placeholder="管理员ID"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
...
<script>
    $("#login_button").click(function () {
        ...
        $.ajax({
            url: "/admin/check?name="+$('#name').val()+"&password="+$('#password').val(),
            type: "GET",
