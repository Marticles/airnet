            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">全球污染物分布图</li>
                    </ol>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="col-md-12" align="center">
                                <iframe frameborder="0" width="100%" height="450px" scrolling="no"
                                        src="https://airvisual.com/earth" id="iframeCompare" name="iframeCompare"
                                        style="display: -webkit-flex;display: flex;-webkit-flex-direction: row-reverse;flex-direction: row-reverse;"></iframe>
                            </div>
                        </div>
