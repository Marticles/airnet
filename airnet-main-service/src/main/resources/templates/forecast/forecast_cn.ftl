            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">全国空气质量预报地图</li>
                    </ol>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <span>全国空气质量预报地图(数据来自南大国际地球系统科学研究所区域空气质量预报系统JAirFS)</span>
                            ...
                            <div class="col-md-12" align="center">
                                        <ul class="nav nav-tabs customtab" role="tablist">
                                            ...
                                            <#list timeList as time>
                                                <#if i==1>
                                                <li class="nav-item"> <a class="nav-link show active" data-toggle="tab" href="#day${i}" role="tab" aria-selected="true"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">${time!}</span></a> </li>
                                                <#else>
                                                <li class="nav-item"> <a class="nav-link show" data-toggle="tab" href="#day${i}" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">${time!}</span></a> </li>
                                                </#if>
                                            <#assign i += 1>
                                            </#list>
                                            </ul>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane p-20 show" id="day1" role="tabpanel">
                                            <#list day1ImgList as day1>
                                            <img src="http://carbon.nju.edu.cn/${day1}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                            <div class="tab-pane p-20 show" id="day2" role="tabpanel">
                                            <#list day2ImgList as day2>
                                                <img src="http://carbon.nju.edu.cn/${day2}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                            <div class="tab-pane p-20 show" id="day3" role="tabpanel">
                                            <#list day3ImgList as day3>
                                                <img src="http://carbon.nju.edu.cn/${day3}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                            <div class="tab-pane p-20 show" id="day4" role="tabpanel">
                                            <#list day4ImgList as day4>
                                                <img src="http://carbon.nju.edu.cn/${day4}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                            <div class="tab-pane p-20 show" id="day5" role="tabpanel">
                                            <#list day5ImgList as day5>
                                                <img src="http://carbon.nju.edu.cn/${day5}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                            <div class="tab-pane p-20 show" id="day6" role="tabpanel">
                                            <#list day6ImgList as day6>
                                                <img src="http://carbon.nju.edu.cn/${day6}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                            <div class="tab-pane p-20 show" id="day7" role="tabpanel">
                                            <#list day7ImgList as day7>
                                                <img src="http://carbon.nju.edu.cn/${day7}" style="width: 40%;height:40%"/>
                                            </#list>
                                            </div>
                                        </div>
