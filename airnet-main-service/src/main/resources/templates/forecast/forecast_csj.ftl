            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">长三角空气质量预报地图</li>
                    </ol>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <span>长三角空气质量预报地图(数据来自南大国际地球系统科学研究所区域空气质量预报系统JAirFS)</span>
                            ...
                            <div class="col-md-12" align="center">
                                <ul class="nav nav-tabs customtab" role="tablist">
                                            ...
                                            <#list timeList as time>
                                                <#if i==1>
                                                <li class="nav-item"> <a class="nav-link active show"  data-toggle="tab" href="#day${i}" role="tab" aria-selected="true"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">${time!}</span></a> </li>
                                                <#else>
                                                <li class="nav-item"> <a class="nav-link show" data-toggle="tab" href="#day${i}" role="tab" ><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">${time!}</span></a> </li>
                                                </#if>
                                                <#assign i += 1>
                                            </#list>
                                </ul>
